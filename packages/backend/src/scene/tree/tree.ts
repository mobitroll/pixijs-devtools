...
import type { PixiNodeType, TreeExtension } from '@kahoot/pixi-devtools';
...
export class Tree extends PixiHandler {
   ...
   * The location is injected at build time by the @kahoot/pixi-devtools Vite plugin, which tags each
